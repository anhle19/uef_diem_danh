...
namespace uef_diem_danh.Migrations
{
    ...
    [Migration("20250828005108_AddRelationShipsBetweenUsersAndSuKienTable")]
    partial class AddRelationShipsBetweenUsersAndSuKienTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("uef_diem_danh.Models.SuKien", b =>
                {
                    ...
                    b.Property<string>("MaNguoiPhuTrach")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("uef_diem_danh.Models.SuKien", b =>
                {
                    b.HasOne("uef_diem_danh.Models.NguoiDungUngDung", "NguoiPhuTrach")
                        .WithMany("SuKiens")
